...
public class CameraController : MonoBehaviour
{
  ...
  void LateUpdate()
  {
    ...
    if (Physics.SphereCast(pivot, collisionRadius, toCam.normalized, out RaycastHit hit, desiredMagnitude, collisionMask, QueryTriggerInteraction.Ignore)) safeDistance = Mathf.Clamp(hit.distance - collisionBuffer, minDistance, distance);
    else safeDistance = Mathf.Clamp(distance, minDistance, maxDistance);
